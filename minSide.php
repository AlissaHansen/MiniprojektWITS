...
<body>
    ...
    <?php
    if (!isset($_SESSION['user'])){ // Hvis der ikke findes en session for brugeren, bliver brugeren sendt til login side. 
        header('Location:login.php');
        exit;
    }
    
    $userInfo = get_user($_SESSION['user']);
    $userID = htmlspecialchars($userInfo['uid']);
   ...
   echo "</div>";
    ...
    foreach ($pids as $pid) { // Gennemgår alle posts som brugeren har oprettet. 
